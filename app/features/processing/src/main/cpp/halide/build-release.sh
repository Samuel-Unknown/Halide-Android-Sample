...
echo "Build Release Halide Generators"
...
# set build dir
BUILD_DIR="$PWD/../../../../build/cmake-build-release"

# delete cmake-build-release folder
rm -rf "$BUILD_DIR"

cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_MAKE_PROGRAM=ninja -G Ninja -S "$PWD" -B "$BUILD_DIR"
